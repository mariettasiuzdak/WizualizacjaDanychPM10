...
while($row = mysql_fetch_array($result1))
{
        ...
        $sql2 = "select sensor_id, date,hour, pm10, pm25, humidity, temperature, wind from data where date='$chosenDate' and hour like '$chosenHour%' and sensor_id=$id limit 1;";
